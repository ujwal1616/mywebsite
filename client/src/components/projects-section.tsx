...
import { Handshake, Smartphone, QrCode } from "lucide-react";

// Create a safe icon mapper
const IconMap = {
  Handshake,
  Smartphone,
  QrCode,
...
interface Project {
  ...
  gradient: string;
  tags: string[];
  tagColor: "primary" | "accent" | "secondary";
}
              ...
              >
                <CardContent className="p-6">
                  ...
                  <div className={`h-48 bg-gradient-to-br ${project.gradient} rounded-lg mb-6 flex items-center justify-center`}>
                    <IconComponent className="text-4xl text-white w-16 h-16" />
                  </div>
